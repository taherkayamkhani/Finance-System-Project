...
public class ExpensesServlet extends HttpServlet {
	...
	/**
	 * this  servlet  is  used  for  Editing  the   Expenditure   budget  of state 
	 */
...
es.setTravel(req.getParameter("travel"));
	...
	es.setFinyear(hs.getAttribute("year1").toString());
...
ex.setFinyear(hs.getAttribute("year1").toString());
es.setQuaterly(hs.getAttribute("qtrly1").toString());
es.setFinyear2(hs.getAttribute("year1").toString());

System.out.println("cal"+ex.getFinyear());
System.out.println("cal"+ex.getStatename());
System.out.println("cal"+es.getQuaterly());
String str1="";
String str= user.editExpenses(es);
...
if(str.equals("daysOver")){
	...
	+"				text-shadow: 0 1px 1px rgba(0,0,0,0.5);"
				+"}"
		+"	</style> <script type='text/javascript'>alert('sorry   no updation!!!!! you  have  crossed  the  day  limit  for  updation .!!!!'); window.location = 'http://localhost:9090/IndianEmergencyCommunicationsFinanceSystem/state.html';</script> </head><body background='kk123.jpg'></body></html>");
...
System.out.println(str);		
	...
	+"				text-shadow: 0 1px 1px rgba(0,0,0,0.5);"
				+"}"
		+"	</style> <script type='text/javascript'>alert('Budget Report for "+es.getFinyear()+"' of "+es.getStatename()+" and  not been  inserted  please  vist  insert page  for  inserting the  details of  this year'); window.location = 'http://localhost:9090/IndianEmergencyCommunicationsFinanceSystem/state.html';</script> </head><body background='kk123.jpg'></body></html>");
