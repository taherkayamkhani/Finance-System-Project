...
public class EstimationBudget extends HttpServlet {
...
if(str.equals("Exists")){
	...
	+"				text-shadow: 0 1px 1px rgba(0,0,0,0.5);"
				+"}"
		+"	</style> <script type='text/javascript'>alert(' till now  Estimation   has  not been  submitted for  "+es.getStatename()+"  please go to Insert Section for  Inserting fresh Estimation Budget'); window.location = 'http://localhost:9090/IndianEmergencyCommunicationsFinanceSystem/index5.html';</script> </head><body background='kk123.jpg'></body></html>");
...
System.out.println(str);		
...
else if(str.equals("budgetSubmitted")){
	pw.println("<html><head><tittle></title><link rel='stylesheet' type='text/css' href='css/style5.css' /><link rel='stylesheet' type='text/css' href='css/style2.css' /><link rel='stylesheet' type='text/css' href='css/style12.css' /> <style>"	
			+"	@import url(http://fonts.googleapis.com/css?family=Montserrat:400,700|Handlee);"
			+"	body {"
				+"	background: #eedfcc url(kk123.jpg) ;"
	...
	+"				text-shadow: 0 1px 1px rgba(0,0,0,0.5);"
				+"}"
		+"	</style> <script type='text/javascript'>alert('Estimation  for  "+es.getStatename()+" has  been updated'); window.location = 'http://localhost:9090/IndianEmergencyCommunicationsFinanceSystem/index5.html';</script> </head><body background='kk123.jpg'></body></html>");
