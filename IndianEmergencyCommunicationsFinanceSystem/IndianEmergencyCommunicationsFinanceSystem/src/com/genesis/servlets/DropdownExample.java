...
public class DropdownExample extends HttpServlet {

	/**
	 * this servlet  is  used   for  displaying  the  dropdown list   for  estimation  in html  format.. 
	 */
...
String str1="";
	...
	state1[a]=rs.getString(2);
	 ...
	 str1="<form class='form1' action='SingleBudget' method='get' id='f1'>"
